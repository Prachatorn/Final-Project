...
#Shiny ui
shinyUI(
  navbarPage("Affirmative and Defensive Asylum",
             tabPanel("plot",
                      titlePanel("Affirmative and Defensive"),
                      sidebarLayout(
                        sidebarPanel(
                          #1st chart and widget combination choosing ethnicity
                          selectInput("country", label = h3("Affirmative Asylum - Select Country"),
                                      choices = gather_affirm$Country,
                                      selected = 1),
                
                          #2nd chart and widget combination choosing ethnicity
                            selectInput("select_country", label = h3("Defensive Asylum - Select Country"),
